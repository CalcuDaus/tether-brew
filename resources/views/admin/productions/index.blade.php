...
@section('title', 'Riwayat Input Produksi (Stok)')

@section('actions')
    <a href="{{ route('admin.productions.create') }}" class="btn btn-primary flex-center btn-sm" style="gap:0.5rem;">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Data Produksi Harian</h3>
    </div>

    {{-- Date Filter --}}
    <div class="card-body" style="border-bottom: 1px solid var(--border-color); padding-bottom: 20px;">
        <form method="GET" action="{{ route('admin.productions.index') }}"
            ...
            <div class="form-group" style="display: flex; gap: 8px; margin-bottom: 0;">
                ...
                <a href="{{ route('admin.productions.index') }}" class="btn btn-secondary"
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th>Diinput Oleh</th>
                        <th style="text-align: center;">Total Items Diproduksi</th>
                    ...
                    @forelse($productions as $prod)
                        <tr>
                            ...
                            <td style="text-align: center; font-weight: 600;">
                                {{ $prod->items->sum('quantity_produced') }}
                            </td>
                            <td style="text-align: center;">
                                <div style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                    <a href="{{ route('admin.productions.add', $prod->id) }}" class="btn btn-outline-success btn-sm flex-center" title="Tambah Stok Tambahan" style="border-color: #22c55e; color: #22c55e;">
                                    ...
                                    <a href="{{ route('admin.productions.show', $prod->id) }}" class="btn btn-outline-info btn-sm flex-center" title="Detail">
                                    ...
                                    <a href="{{ route('admin.productions.edit', $prod->id) }}" class="btn btn-outline-primary btn-sm flex-center" title="Edit">
                                    ...
                                    <form action="{{ route('admin.productions.destroy', $prod->id) }}" method="POST" style="display:inline-block; margin: 0;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline-danger btn-sm flex-center" title="Hapus">
