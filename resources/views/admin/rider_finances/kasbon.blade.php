...
<div id="print-area">
    <div class="print-title print-only" style="display: none;">
        ...
        <p style="margin: 5px 0 0; color: #64748b; font-size: 10pt;">Laporan Kasbon Rider — Dicetak: {{ now()->translatedFormat('d F Y') }}</p>
    </div>
...
<div class="card">
    <div class="card-header print-hide" style="padding-bottom: 0;">
        <form method="GET" action="{{ route('admin.rider_finances.kasbon') }}" style="display: flex; gap: 15px; align-items: flex-end; flex-wrap: wrap; margin-bottom: 20px;">
            ...
            <div class="form-group" style="display: flex; gap: 8px; margin-bottom: 0;">
                ...
                <a href="{{ route('admin.rider_finances.kasbon') }}" class="btn btn-secondary" style="height: 42px; display: flex; align-items: center;">Reset</a>
        ...
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 30px;">Belum ada riwayat kasbon.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<div id="financeModal" class="modal-overlay-animate" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.7); z-index: 1000; align-items: center; justify-content: center; backdrop-filter: blur(4px);">
    <div class="card modal-content-animate" style="width: 100%; max-width: 500px; margin: 20px; box-shadow: var(--shadow-lg);">
        <div class="card-header">
            <h3 class="card-title">Input Kasbon Rider</h3>
        </div>
        <div class="card-body">
