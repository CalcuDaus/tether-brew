        ...
        <form action="{{ route('admin.rider_sales.store') }}" method="POST" id="sales-form">
            ...
            <div style="margin-bottom: 30px; padding: 25px; background: rgba(0,0,0,0.02); border: 1px solid var(--border-color); border-radius: 12px;">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    <div class="form-group" style="flex: 1; margin: 0;">
                        ...
                        <input type="number" name="cash_amount" id="cash-amount" class="form-input" style="height: 44px; font-size: 1rem; font-weight: 600;">
                    </div>
                    <div class="form-group" style="flex: 1; margin: 0;">
                        <label class="form-label" style="font-weight: 600;">QRIS</label>
                        <input type="number" name="qris_amount" class="form-input" style="height: 44px; font-size: 1rem; font-weight: 600;">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    <div class="form-group" style="flex: 1; margin: 0;">
                        ...
                        <input type="number" name="actual_setor" id="actual-setor" class="form-input" required style="height: 44px; font-size: 1rem; font-weight: 600; border-color: #3b82f6;">
                    </div>
                    <div class="form-group" style="flex: 1; margin: 0;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 20px;">
                <div class="form-group" style="flex: 1; max-width: 300px; margin: 0;">
                    ...
                    <input type="text" name="admin_pemeriksa" class="form-input" value="{{ auth()->user()->name }}" style="height: 48px; font-size: 1rem;">
                </div>
