...
@section('title', 'Input Produk Basi')
...
<div class="card mb-4" style="max-width: 1400px; margin: 0 auto; background: var(--bg-card);">
    <div class="card-header" style="text-align: center; border-bottom: 2px solid var(--border-color); padding: 20px;">
        <h2 style="font-weight: 700; color: var(--text-primary); margin: 0; font-size: 1.5rem; letter-spacing: 1px;">INPUT PRODUK BASI</h2>
    </div>

    <div class="card-body">
        <form action="{{ route('admin.spoiled_products.store') }}" method="POST" id="spoiled-form">
            @csrf
            ...
            <div style="display: flex; gap: 15px; justify-content: flex-end;">
                ...
                <button type="submit" class="btn btn-primary" style="height: 48px; padding: 0 40px; font-size: 1rem; font-weight: 600;">Simpan Produk Basi</button>
            </div>
        </form>
    </div>
</div>
